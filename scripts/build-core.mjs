...
const cliBuild = spawnSync(process.execPath, [
  resolve(root, "desktop/cli/scripts/build.mjs"),
...
await rm(resolve(outDir, "cli.mjs"), { force: true });
await rm(resolve(outDir, "cli.mjs.map"), { force: true });
