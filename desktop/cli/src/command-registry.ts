...
export const COMMAND_REGISTRY: readonly CommandDefinition[] = Object.freeze([
  ...
  command(["marketplace", "list"], "marketplace.list", "marketplace list [--kind <app|connector>] [--json]", "List current Marketplace package candidates.", both),
  ...
  command(["app", "create"], "app.create", "app create --from <package-id> [--as <local-app-id>] [--json]", "Create an editable App from a Marketplace template.", both),
